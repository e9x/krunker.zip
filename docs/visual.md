...
This documentation provides an overview of the recommended settings for the visual features in the game. These features include the disabling of the ADS FOV multiplier and various ESP options.

## Disable ADS FOV Multiplier
